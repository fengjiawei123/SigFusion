...
for fusion_name in ['Fusion']:
    ...
    IR_files = sorted(get_img_file(r"data/RealMFF/imageA/"))
    VIS_files = sorted(get_img_file(r"data/RealMFF/imageB/"))
    fusion_files = sorted(get_img_file(r"data/RealMFF/" + fusion_name))
