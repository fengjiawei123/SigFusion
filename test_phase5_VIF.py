...
import torchvision
from CustomDataset_color import MyDataset, yuv2rgb
import numpy as np
import cv2
'''
------------------------------------------------------------------------------
...
for i, (data_IR,data_VIS_y, data_VIS_uv) in enumerate(train_loader):
    ...
    with torch.no_grad():
        ...
        path = "results/PhaseⅤ_TEST/"+Modality+dataset
        ...
        for b in range(batch_size):
            ...
            torchvision.utils.save_image(data_Fuse_color,path+f'/{i+1}.bmp')
            print("save:"+ dataset +f'_fusion{i+1}.bmp')
